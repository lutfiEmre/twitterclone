...
const MenuCategory = () => {
    return(
       <>
           <div className={'flex flex-row h-14 sm:w-full w-10  items-center pl-5 gap-5 cursor-pointer hover:bg-gray-100 '}>
               ...
               <h2 className={'text-xl hidden sm:flex font-bold'}>Home</h2>
           </div>
           <div className={'flex flex-row h-14 sm:w-full w-10 items-center pl-5 gap-5 cursor-pointer hover:bg-gray-100'}>
               <svg viewBox="0 0 24 24" aria-hidden="true" >
                   <g>
                       <path
                           d="M10.09 3.098L9.72 7h5.99l.39-4.089 1.99.187L17.72 7h3.78v2h-3.97l-.56 6h3.53v2h-3.72l-.38 4.089-1.99-.187.36-3.902H8.78l-.38 4.089-1.99-.187L6.77 17H2.5v-2h4.46l.56-6H3.5V7h4.21l.39-4.089 1.99.187zM14.96 15l.56-6H9.53l-.56 6h5.99z"></path>
                   </g>
               </svg>
               <h2 className={'text-xl hidden sm:flex'}>Explore</h2>
           </div>
           <div className={'flex flex-row h-14 sm:w-full w-10 items-center pl-5 gap-5 cursor-pointer hover:bg-gray-100'}>
               ...
               <h2 className={'text-xl hidden sm:flex'}>Notifications</h2>
           </div>
           <div className={'flex flex-row h-14 sm:w-full w-10 items-center pl-5 gap-5 cursor-pointer hover:bg-gray-100'}>
               <svg viewBox="0 0 24 24" aria-hidden="true" className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                   <g>
               ...
               <h2 className={'text-xl hidden sm:flex'}>Messages</h2>
           </div>
           <div className={'flex flex-row h-14 sm:w-full w-10 items-center pl-5 gap-5 cursor-pointer hover:bg-gray-100'}>
               <svg viewBox="0 0 24 24" aria-hidden="true" className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                   <g>
               ...
               <h2 className={'text-xl hidden sm:flex'}>Bookmarks</h2>
           </div>
           <div className={'flex flex-row h-14 sm:w-full w-10  items-center pl-5 gap-5 cursor-pointer hover:bg-gray-100'}>
               <svg viewBox="0 0 24 24" aria-hidden="true" className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                   <g>
               ...
               <h2 className={'text-xl hidden sm:flex'}>Twitter Blue</h2>
           </div>
           <div className={'flex flex-row h-14 sm:w-full w-10 items-center pl-5 gap-5 cursor-pointer hover:bg-gray-100'}>
               <svg viewBox="0 0 24 24" aria-hidden="true" className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                   <g>
               ...
               <h2 className={'text-xl hidden sm:flex'}>Profile</h2>
           </div>
           <div className={'flex flex-row h-14 sm:w-full w-10 items-center pl-5 gap-5 cursor-pointer hover:bg-gray-100'}>
               <svg viewBox="0 0 24 24" aria-hidden="true" className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                   <g>
               ...
               <h2 className={'text-xl hidden sm:flex'}>More</h2>
           </div>
